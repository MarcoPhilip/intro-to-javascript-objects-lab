...
game.party.push(pokemon[51],pokemon[149],pokemon[24])
...
game.party.splice(1, 1, pokemon[52]);
game.party.splice(2, 1, pokemon[150]);
...
let myParty = game.party

for (let i = 0; i < myParty.length; i++) { 
    console.log("Exercise 8 result: " + myParty[i].name);
}
